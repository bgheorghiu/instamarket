...
class _$PostInfo extends PostInfo {
  ...
  _$PostInfo._({this.paths, this.description, this.lng, this.lat}) : super._();
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc($jc(0, paths.hashCode), description.hashCode), lng.hashCode), lat.hashCode));
  }
...
class PostInfoBuilder implements Builder<PostInfo, PostInfoBuilder> {
  ...
  _$PostInfo build() {
    _$PostInfo _$result;
    try {
      _$result = _$v ?? new _$PostInfo._(paths: _paths?.build(), description: description, lng: lng, lat: lat);
    } catch (_) {
